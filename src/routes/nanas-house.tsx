  ...
  component: () => (
    <SceneLayout particles="hearts">
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        <Reveal>
          <motion.div whileHover={{ scale: 1.02 }} className="glass-rose rounded-3xl p-12 text-center relative overflow-hidden">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 my-10 justify-items-center">
          <PhotoFrame src={photos.cafe} alt="together" rotate={-4} className="w-full" />
          <PhotoFrame src={photos.hug} alt="hug" rotate={2} className="w-full" />
          <PhotoFrame src={photos.hands} alt="hands" rotate={-2} className="w-full" />
        </div>
        {[
