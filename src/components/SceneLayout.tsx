    ...
    <div className="relative min-h-screen w-full bg-[color:var(--cream)]">
      ...
      <main className="relative z-10 pt-36 md:pt-40 pb-32 px-4 md:px-8">
        <div className="mx-auto max-w-6xl">
          <div className={`paper rounded-sm px-6 md:px-14 py-10 md:py-16 ${paperOpacity > 0 ? "backdrop-blur-md shadow-2xl" : ""}`} style={{ backgroundColor: `color-mix(in srgb, var(--cream) ${paperOpacity * 100}%, transparent)` }}>
            {children}
          </div>
